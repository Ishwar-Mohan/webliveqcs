        ...
        <div style={mystyle}>
          ...
          >
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <a
                href="/customerlogin"
                style={{ color: "white", textDecoration: "none" ,marginLeft:"1670px" }}
              >
                User Login &nbsp;|
              </a>
              &nbsp;&nbsp;{" "}
          ...
          <div>
            <div className={homecss.wrapper}>
              ...
              <div className={homecss.card} style={{marginRight:"70px"}}>
                <img src="caree1.jpg" />
              ...
              <div className={homecss.card} style={{marginRight:"40px",marginLeft:"40px"}}>
                <img src="caree2.jpg" />
                <div className={homecss.info}>
